...
help() {
        ...
        echo ""
        echo "Options:"
        echo "--clean      : remove contents of the configured build directory"
...
SOURCE_DIR=$(CDPATH= cd -- "$(dirname -- "$SCRIPT_PATH")" && pwd -P)
BUILD_DIR=${ANBOX_REBOXED_BUILD_DIR:-$(dirname -- "$SOURCE_DIR")/build}
