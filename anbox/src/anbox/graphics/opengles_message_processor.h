...
class OpenGlesMessageProcessor : public network::MessageProcessor {
 public:
  ...
  // Guest decoder threads and host presentation share one EGL/GLES driver.
  // Serialize their driver calls across qemu-pipe connections and compositor
  // draws.
  static std::recursive_mutex& host_gles_lock();
