...
class EventDevice {
 public:
  ...
  virtual bool deliver_events(const std::vector<Event> &events,
                              std::uint64_t monotonic_timestamp_ns,
                              bool include_legacy_connections) = 0;
};

class Device : public EventDevice,
 ...
 public:
  ...
  bool deliver_events(const std::vector<Event> &events,
                      std::uint64_t monotonic_timestamp_ns,
                      bool include_legacy_connections) override;
  ...
  bool create_uinput_device();
  std::string uinput_event_path() const { return uinput_event_path_; }
  bool ready() const { return uinput_fd_ >= 0; }
