...
class SessionManager : public cli::CommandWithFlagsAndAction {
 ...
 private:
  ...
  std::string orientation_ = "auto";
  std::string renderer_backend_ = "reboxed";
  std::string graphics_api_ = "auto";
  std::string input_backend_ = "reboxed";
  std::string key_repeat_ = "ignore";
  bool single_window_ = false;
  graphics::Rect window_size_;
  graphics::Rect android_size_{0, 0, 720, 1600};
  int density_ = 320;
  bool standalone_ = false;
  bool experimental_ = false;
  bool use_system_dbus_ = false;
  bool no_dbus_service_ = false;
  bool use_software_rendering_ = false;
  bool allow_software_fallback_ = false;
