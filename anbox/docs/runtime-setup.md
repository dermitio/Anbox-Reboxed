...
The Anbox Reboxed runtime consists mainly of two separate instances:
...
![Anbox Reboxed architecture](architecture.png)
...
a set of layers to composite on a screen. Anbox Reboxed tells SurfaceFlinger through its
